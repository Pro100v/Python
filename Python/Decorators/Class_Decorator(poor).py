...
class TimeItCritical:
    def __new__(cls, *args, **kwargs):
        print("TimeItCritical.__new__", cls, args, kwargs)              
        obj = super(TimeItCritical, cls).__new__(cls, *args, **kwargs)
        return obj
    ...
    def __init__(self, obj=None, * , critical_time=0.5):
        ...
        functools.update_wrapper(self, obj, updated=[])
    ...
    def wrap_all_methods(self):
        @functools.wraps(self._cls, updated=[])
        class FakeCls():
